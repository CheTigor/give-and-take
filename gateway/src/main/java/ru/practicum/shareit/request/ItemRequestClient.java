...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> createRequest(ItemRequestPostRequest description, Long userId) {
    ...
    public ResponseEntity<Object> getAllAnotherRequests(Long userId, Integer from, Integer size) {
